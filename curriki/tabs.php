...
/**
 * Outputs navigation tabs for the curriki report
 *
 ...
 */
    ...
    $row[] = new tabobject('currikireport',
                           $CFG->wwwroot.'/grade/report/curriki/index.php?id='.$courseid,
                           get_string('pluginname', 'gradereport_curriki'));
    if (has_capability('moodle/grade:manage',$tabcontext ) ||
        has_capability('moodle/grade:edit', $tabcontext) ||
        has_capability('gradereport/curriki:view', $tabcontext)) {
        $row[] = new tabobject('preferences',
                               $CFG->wwwroot.'/grade/report/curriki/preferences.php?id='.$courseid,
