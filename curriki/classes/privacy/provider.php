...
/**
 * Privacy Subsystem implementation for gradereport_curriki.
 *
...
namespace gradereport_curriki\privacy;
...
/**
 * Privacy Subsystem for gradereport_curriki implementing null_provider.
 *
 * @copyright  2018 Sara Arjona <sara@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference('grade_report_curriki_collapsed_categories', 'privacy:metadata:preference:grade_report_curriki_collapsed_categories');
        ...
        foreach ($preferences as $name => $value) {
            ...
            switch ($name) {
                ...
                case 'grade_report_aggregationposition':
                    ...
                    break;
                default:
                    if (strpos($name, 'grade_report_curriki_collapsed_categories') === 0) {
                        $prefname = 'grade_report_curriki_collapsed_categories';
                        $courseid = substr($name, strlen('grade_report_curriki_collapsed_categories'));
                        $transformedvalue = $value;
            ...
            if ($prefname !== null) {
                if ($prefdescription == null) {
                    $prefdescription = get_string('privacy:metadata:preference:'.$prefname, 'gradereport_curriki');
                }
