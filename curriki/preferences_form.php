...
/**
 * Form for curriki report preferences
 *
 ...
 */
class curriki_report_preferences_form extends moodleform {
...
//--------------------------------------------------------------------------------
        ...
        // View capability is the lowest permission. Users with grade:manage or grade:edit must also have curriki:view
        if (has_capability('gradereport/curriki:view', $context)) {
