...
$url = new moodle_url('/grade/report/curriki/quickedit_item.php', array('id'=>$courseid, 'itemid'=>$itemid));
if ($page !== 0) {
    $url->param('page', $page);
}
if ($perpage !== 0) {
...
$gpr = new grade_plugin_return(array('type'=>'report', 'plugin'=>'curriki', 'courseid'=>$courseid, 'page'=>$page));
...
// Initialise the curriki report object
$report = new grade_report_curriki($courseid, $gpr, $context, $page);
...
$reportname = get_string('quickedititem', 'gradereport_curriki', $a);
print_grade_page_head($COURSE->id, 'report', 'curriki', $reportname);
