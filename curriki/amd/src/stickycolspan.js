 ...
 *
 * @module      gradereport_curriki/stickycolspan
...
export const init = () => {
    ...
    const curriki = document.querySelector(SELECTORS.GRADEPARENT);
    const studentHeader = curriki.querySelector(SELECTORS.STUDENTHEADER);
    ...
    curriki.querySelectorAll(SELECTORS.TABLEHEADER).forEach((tableHeader) => {
