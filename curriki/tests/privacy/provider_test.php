...
/**
 * Unit tests for the gradereport_curriki implementation of the privacy API.
 *
...
use gradereport_curriki\privacy\provider;
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences_single() {
        ...
        $prefs = $writer->get_user_preferences('gradereport_curriki');
        $this->assertCount(3, (array) $prefs);
        $this->assertEquals(
            get_string('privacy:metadata:preference:grade_report_showcalculations', 'gradereport_curriki'),
    ...
    public function test_export_user_preferences_multiple() {
        ...
        set_user_preference('grade_report_curriki_collapsed_categories'.$course->id, $collapsed, $user);
        ...
        $this->assertEquals(
            get_string('privacy:request:preference:grade_report_curriki_collapsed_categories', 'gradereport_curriki', ['name' => $course->fullname]),
            $prefs->grade_report_curriki_collapsed_categories->description
        );
    }
}
