@gradereport @gradereport_curriki
Feature: Using the AJAX grading feature of Curriki report to update grades and feedback
  ...
  @javascript
  Scenario: Use the curriki report without editing, with AJAX on and quick feedback off
    When the following config values are set as admin:
      | grade_overridecat | 1 |
      | grade_report_showquickfeedback | 0 |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to "View > Curriki report" in the course gradebook
  ...
  @javascript
  Scenario: Use the curriki report without editing, with AJAX and quick feedback on
    When the following config values are set as admin:
      | grade_overridecat | 1 |
  ...
  @javascript
  Scenario: Use the curriki report without editing, with AJAX and quick feedback on, without category override
    When the following config values are set as admin:
      | grade_overridecat | 0 |
      | grade_report_showquickfeedback | 1 |
    And I log in as "teacher1"
  ...
  @javascript
  Scenario: Use the curriki report with editing, with AJAX and quick feedback on, with category override
    When the following config values are set as admin:
      | grade_overridecat | 1 |
      | grade_report_showquickfeedback | 1 |
    And I log in as "teacher1"
  ...
  @javascript
  Scenario: Use the curriki report with editing, with AJAX and quick feedback on, without category override
    When the following config values are set as admin:
      | grade_overridecat | 0 |
      | grade_report_showquickfeedback | 1 |
    And I log in as "teacher1"
  ...
  @javascript
  Scenario: Teacher can see an error when an incorrect grade is given using the curriki report with editing and AJAX on
  ...
  Scenario: Teacher can see user custom filed columns as additional user identity
    ...
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I navigate to "View > Curriki report" in the course gradebook
