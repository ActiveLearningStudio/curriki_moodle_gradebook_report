...
Feature: We can change what we are viewing on the curriki report
  ...
  @javascript
  Scenario: View and minimise the curriki report containing hidden activities
  ...
  Scenario: View and minimise the curriki report containing hidden activities without the 'moodle/grade:viewhidden' capability
    When I am on "Course 1" course homepage with editing mode on
    And I open "Test assignment name 2" actions menu
    And I click on "Hide" "link" in the "Test assignment name 2" activity
    And I log out
