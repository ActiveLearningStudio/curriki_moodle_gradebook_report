...
/**
 * Strings for component 'gradereport_curriki', language 'en'
 *
...
$string['eventgradereportviewed'] = 'Curriki report viewed';
$string['curriki:manage'] = 'Manage the curriki report';
$string['curriki:view'] = 'View the curriki report';
$string['pluginname'] = 'Curriki report';
$string['preferences'] = 'Curriki report preferences';
...
$string['privacy:metadata:preference:grade_report_enableajax'] = 'Whether to add a layer of AJAX functionality to the curriki report, simplifying and speeding up common operations';
$string['privacy:metadata:preference:grade_report_curriki_collapsed_categories'] = 'List of gradebook categories to be collapsed';
...
$string['privacy:metadata:preference:grade_report_studentsperpage'] = 'The number of students displayed per page in the curriki report';
$string['privacy:request:preference:grade_report_curriki_collapsed_categories'] = 'You have some gradebook categories collapsed in the "{$a->name}" course';
$string['summarycurriki'] = 'A table with the names of students in the first column, with assessable activities grouped by course and category across the top.';
