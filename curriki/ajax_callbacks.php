...
/**
 * This file receives ajax callbacks for the curriki report
 *
...
// require_once $CFG->dirroot.'/grade/report/curriki/ajaxlib.php';
...
switch ($action) {
    case 'update':
        ...
        if (!empty($userid) && !empty($itemid) && $newvalue !== false && !empty($type)) {
            ...
            /**
             * Code copied from grade/report/curriki/lib.php line 187+
             */
            $warnings = array();
            $finalvalue = null;
            $finalgrade = null;
